...
public class CurrentObservationDaoImpl implements CurrentObservationDao {
     ...
     */
    @Override
    public void save(com.bellintegrator.model.CurrentObservation currentObservation) {
     ...
     */
    @Override
    public com.bellintegrator.model.CurrentObservation findByParameters(Integer woeid) {
